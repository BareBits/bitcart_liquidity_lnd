...
from loop_proto import client_pb2 as client__pb2
...
class SwapClientStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListSwaps = channel.unary_unary(
                ...
                _registered_method=True)
        self.SweepHtlc = channel.unary_unary(
                '/looprpc.SwapClient/SweepHtlc',
                request_serializer=client__pb2.SweepHtlcRequest.SerializeToString,
                response_deserializer=client__pb2.SweepHtlcResponse.FromString,
                _registered_method=True)
        ...
        self.StopDaemon = channel.unary_unary(
                ...
                request_serializer=client__pb2.StopDaemonRequest.SerializeToString,
                response_deserializer=client__pb2.StopDaemonResponse.FromString,
                _registered_method=True)
        ...
        self.StaticAddressLoopIn = channel.unary_unary(
                ...
                _registered_method=True)
        self.StaticOpenChannel = channel.unary_unary(
                '/looprpc.SwapClient/StaticOpenChannel',
                request_serializer=client__pb2.StaticOpenChannelRequest.SerializeToString,
                response_deserializer=client__pb2.StaticOpenChannelResponse.FromString,
                _registered_method=True)
...
class SwapClientServicer(object):
    ...
    def SweepHtlc(self, request, context):
        """loop: `sweephtlc`
    ...
    def StaticOpenChannel(self, request, context):
...
def add_SwapClientServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SweepHtlc': grpc.unary_unary_rpc_method_handler(
                    servicer.SweepHtlc,
                    request_deserializer=client__pb2.SweepHtlcRequest.FromString,
                    response_serializer=client__pb2.SweepHtlcResponse.SerializeToString,
            ),
            ...
            'StopDaemon': grpc.unary_unary_rpc_method_handler(
                    servicer.StopDaemon,
                    request_deserializer=client__pb2.StopDaemonRequest.FromString,
                    response_serializer=client__pb2.StopDaemonResponse.SerializeToString,
            ),
            ...
            'StaticOpenChannel': grpc.unary_unary_rpc_method_handler(
                    servicer.StaticOpenChannel,
                    request_deserializer=client__pb2.StaticOpenChannelRequest.FromString,
                    response_serializer=client__pb2.StaticOpenChannelResponse.SerializeToString,
            ),
    }
...
class SwapClient(object):
    ...
    def SweepHtlc(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/looprpc.SwapClient/SweepHtlc',
            client__pb2.SweepHtlcRequest.SerializeToString,
            client__pb2.SweepHtlcResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def StopDaemon(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/looprpc.SwapClient/StopDaemon',
            client__pb2.StopDaemonRequest.SerializeToString,
            client__pb2.StopDaemonResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def ListUnspentDeposits(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def ListStaticAddressDeposits(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def ListStaticAddressWithdrawals(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def ListStaticAddressSwaps(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def GetStaticAddressSummary(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def StaticAddressLoopIn(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    def StaticOpenChannel(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/looprpc.SwapClient/StaticOpenChannel',
            client__pb2.StaticOpenChannelRequest.SerializeToString,
            client__pb2.StaticOpenChannelResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
